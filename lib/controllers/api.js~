...
exports.query = function(req, res) {
	if (!req.query.q) { return res.send(400, 'No query specified!'); }
	if ( restricted.some(function(word) { return req.query.q.toLowerCase().indexOf(word) + 1; })) { return res.send(400, 'You naughty boy!'); }
